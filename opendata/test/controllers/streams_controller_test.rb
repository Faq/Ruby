...
class StreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post streams_url, params: { stream: { country: @stream.country, date: @stream.date, departure: @stream.departure, self_isolation: @stream.self_isolation, twoweek_cumulative: @stream.twoweek_cumulative } }
    end
  ...
  test "should update stream" do
    patch stream_url(@stream), params: { stream: { country: @stream.country, date: @stream.date, departure: @stream.departure, self_isolation: @stream.self_isolation, twoweek_cumulative: @stream.twoweek_cumulative } }
